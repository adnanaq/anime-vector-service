...
def main():
    ...
    if len(sys.argv) != 3:
        print("Usage: python process_stage1_metadata.py <current_anime_file> <temp_dir>")
        print("Example: python process_stage1_metadata.py temp/current_anime_1.json temp/One")
        sys.exit(1)
