...
class StatsResponse(BaseModel):
    ...
    additional_stats: Dict[str, Any] = Field(default_factory=dict, description="Additional statistics")
...
async def admin_health_check() -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            ...
            "details": "All systems operational" if qdrant_healthy else "Vector database issues detected"
        }
...
async def reindex_collection() -> Dict[str, Any]:
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Reindex operation failed: {str(e)}")
...
async def get_collection_info() -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            ...
            "stats": stats,
            "processors": {
                "text_processor": qdrant_client.text_processor.get_model_info() if qdrant_client.text_processor else None,
                "vision_processor": qdrant_client.vision_processor.get_model_info() if qdrant_client.vision_processor else None
            }
        }
