...
class AnimeDataset(Dataset):
    ...
    def __getitem__(self, idx: int) -> Dict[str, Any]:
        ...
        return {
            ...
            'title': sample.title,
            'text': sample.text,
            'text_embedding': torch.tensor(text_embedding) if text_embedding is not None else None,
            'image_embedding': torch.tensor(image_embedding) if image_embedding is not None else None,
            'character_labels': character_labels,
            'art_style_label': art_style_label,
            'genre_labels': genre_labels,
            'metadata': {
