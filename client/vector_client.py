...
class VectorServiceClient:
    ...
    async def search_by_image(
        ...
        response = await self._request('POST', '/api/v1/search/image', json_data=request_data)
        return response.get('results', [])
    ...
    async def search_multimodal(
        ...
        response = await self._request('POST', '/api/v1/search/multimodal', json_data=request_data)
        return response.get('results', [])
    ...
    async def find_similar(
        ...
        """
        response = await self._request('GET', f'/api/v1/similarity/anime/{anime_id}', params={'limit': limit})
    ...
    async def find_visually_similar(
        ...
        """
        response = await self._request('GET', f'/api/v1/similarity/visual/{anime_id}', params={'limit': limit})
        return response.get('similar_anime', [])
    ...
    async def find_vector_similar(
        ...
        Returns:
            List of similar anime
        """
        response = await self._request('GET', f'/api/v1/similarity/vector/{anime_id}', params={'limit': limit})
        return response.get('similar_anime', [])
    ...
    async def batch_similarity(
        ...
        response = await self._request('POST', '/api/v1/similarity/batch', json_data=request_data, params=params)
    ...
    async def upsert_vectors(
        ...
        return await self._request('POST', '/api/v1/admin/vectors/upsert', json_data=request_data)
